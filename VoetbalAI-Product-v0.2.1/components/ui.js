...
export function Header(){
 return <><div className="demo">PRODUCTDEMO v0.2.1 <span>•</span> fictieve redactiebeelden • live data voorbereid</div>
...
export function Footer(){return <footer><div className="wrap"><b>VOETBALAI</b><p>AI-native voetbalnieuws • productdemo v0.2.1</p></div></footer>}
