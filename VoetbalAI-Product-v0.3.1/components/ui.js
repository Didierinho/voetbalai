...
export function Header(){
 return <><div className="demo">PRODUCTDEMO v0.3.1 <span>•</span> fictieve beeldidentiteit • AI-redactie voorbereid</div>
...
const editorialImages = {
 "Feyenoord":"/editorial/hero-feyenoord.jpg",
 "PSV":"/editorial/club-training.jpg",
 "Ajax":"/editorial/transfer-silhouette.jpg",
 "Liverpool":"/editorial/europa-stadium.jpg",
 "Oranje":"/editorial/oranje-supporters.jpg",
 "AZ":"/editorial/club-training.jpg",
 "FC Twente":"/editorial/transfer-silhouette.jpg",
 "sc Heerenveen":"/editorial/eredivisie-stadium.jpg",
 "FC Utrecht":"/editorial/eredivisie-stadium.jpg",
 "Europa":"/editorial/europa-stadium.jpg"
};

export function Thumb({a, large=false}){
 const src=editorialImages[a.club] || "/editorial/eredivisie-stadium.jpg";
 return <div className={`photoThumb ${large?"photoHero":""}`}>
   <img src={src} alt="" />
   <div className="photoShade"></div>
   {!large && <div className="photoMeta"><span>{a.category}</span><b>{a.club}</b></div>}
 </div>
}
...
export function Footer(){return <footer><div className="wrap footerGrid"><div><b>VOETBALAI</b><p>AI-native voetbalnieuws • productdemo v0.3.1</p></div><Link href="/redactie">Open redactieomgeving →</Link></div></footer>}
